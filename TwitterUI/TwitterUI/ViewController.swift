...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func shamelessActionThatBringsYouToMyTwitterProfile() {
        ...
        if !UIApplication.sharedApplication().openURL(NSURL(string:"twitter://user?screen_name=@odologies")!){
            UIApplication.sharedApplication().openURL(NSURL(string:"https://twitter.com/odologies")!)
        }
    }
}